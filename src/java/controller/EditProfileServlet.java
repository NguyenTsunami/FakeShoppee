...
public class EditProfileServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc != null) {
            ...
            Account newacc = da.editProfile(id, user, pass, name, mail, phone, gender, dob);

            if (newacc != null) {
                session.setAttribute("acc", newacc);
                request.setAttribute("success", "All changes saved!");
                request.getRequestDispatcher("index.jsp?navActive=myaccount&service=aboutme").forward(request, response);
            } else {
